package dims.springframework.recipes.bootstrap;

import dims.springframework.recipes.domain.*;
...
public class DevBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOptional = getUom("Each");
        Optional<UnitOfMeasure> tableSpoonUomOptional = getUom("Tablespoon");
        Optional<UnitOfMeasure> teaSpoonUomOptional = getUom("Teaspoon");
        Optional<UnitOfMeasure> dashUomOptional = getUom("Dash");
        Optional<UnitOfMeasure> pintUomOptional = getUom("Pint");
        Optional<UnitOfMeasure> cupUomOptional = getUom("Cup");
    ...
    private Optional<UnitOfMeasure> getUom(String name) throws RuntimeException{
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription(name);

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found: " + name);
        }
    ...
    private Optional<Category> getCategory(String name){
        ...
        if(!categoryOptional.isPresent()){
            throw new RuntimeException("Expected category Not Found: " + name);
        }
